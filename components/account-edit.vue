      ...
      <div class="account_form">
        ...
        <div class="account_form_text">
          <div class="account_form_text_name account_form_text_item">
            <p>ユーザーネーム</p>
            <input type="text" name="" value="" maxlength='20' placeholder="てんと一郎" required>
          </div>

          <div class="account_form_text_position account_form_text_item">
            <p>肩書・志望職業</p>
            <input type="text" name="" value="" maxlength='30'　placeholder="デザイナー" required>
          </div>

          <div class="account_form_text_intro account_form_text_item">
            <p>自己紹介</p>
            <textarea name="name" rows="8" cols="80" maxlength='160' placeholder="簡単な自己紹介を記入してください"></textarea>
          </div>
          <div class="">
            <button type="button" name="button" class="btn">この内容を保存</button>
          </div>
        </div>
