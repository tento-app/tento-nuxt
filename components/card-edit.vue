          ...
          <div class="card">
            ...
            <div class="card_txt">
              ...
              <div class="card_txt_user">
                <div class="card_txt_user_img" :style="{ 'background-image' : 'url(https://object-storage.tyo2.conoha.io/v1/nc_ac83d3c0bf5f4fb0a05b3e1c0d3164f4/api/' + project.node.user.logo + ')' }"></div>
                  <div class>
